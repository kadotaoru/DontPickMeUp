package to.msn.wings.dontpickmeup
...
class AlarmService : Service(), SensorEventListener {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, stratId: Int): Int {
...
//        TODO("Not yet implemented")
        ...
        if (event.sensor.type == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (speed > threshold) {
                mp = MediaPlayer.create(applicationContext, R.raw.moshimoshivoice)
                mp?.start()
            }
